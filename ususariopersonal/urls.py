"""
URL configuration for ususariopersonal project.
...
from usupersonal.views import CustomUserListView, CustomUserCreateView, CustomUserUpdateView, CustomUserDeleteView,CustomPasswordChangeView,signout,home
